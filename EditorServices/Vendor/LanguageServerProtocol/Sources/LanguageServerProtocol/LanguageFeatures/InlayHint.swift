...
public struct InlayHintLabelPart: Codable, Hashable, Sendable {
	...
	/// Source-compatible access to the misspelled property from older releases.
	...
	@available(*, deprecated, renamed: "init(value:tooltip:location:command:)")
	public init(
		value: String, tooltop: TwoTypeOption<String, MarkupContent>?,
		location: Location? = nil, command: Command? = nil
	) {
		self.init(value: value, tooltip: tooltop, location: location, command: command)
	}
}

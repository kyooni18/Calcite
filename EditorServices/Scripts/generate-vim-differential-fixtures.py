...
CASES = [
    ...
    ("delete-find-forward", BASE, 14, "df-"),
    ("delete-till-forward", BASE, 14, "dt-"),
    ("delete-repeat-find", "a-b-c-d\n", 0, "f-d;"),
    ("delete-reverse-find", "a-b-c-d\n", 0, "f-;d,"),
    ("delete-sentence", "One sentence. Two sentence. Three.\n", 0, "d)"),
    ("delete-paragraph", "one\ntwo\n\nthree\nfour\n", 0, "d}"),
    ("uppercase-inner-word", BASE, 0, "gUiw"),
    ("lowercase-inner-word", BASE.upper(), 0, "guiw"),
    ("swap-case-word", BASE, 0, "g~w"),
    ("rot13-inner-word", BASE, 0, "g?iw"),
    ("forced-characterwise-down", BASE, 0, "dvj"),
    ("forced-linewise-word", BASE, 0, "dVw"),
    ("match-pair-scan", "abc (de) x\n", 0, "%"),
    ("delete-match-pair-scan", "abc (de) x\n", 0, "d%"),
    ("delete-last-nonblank", "abc   \n", 0, "dg_"),
    ("delete-next-whole-word-match", "foo xx foo yy\n", 0, "d*"),
    ("delete-next-partial-word-match", "foo xx foobar yy\n", 0, "dg*"),
    ("delete-previous-whole-word-match", "foo xx foo yy\n", 7, "d#"),
    ("delete-previous-partial-word-match", "foo xx foobar yy\n", 7, "dg#"),
    ("visual-next-match-delete", "foo xx foo yy foo\n", 0, "*gnd"),
    ("operator-next-match-delete", "foo xx foo yy foo\n", 0, "*dgn"),
    ("visual-previous-match-delete", "foo xx foo yy foo\n", 7, "*gNd"),
]
        ...
        for name, initial, cursor, keys in CASES:
            expanded_cases.append(
                (
                    ...
                    shifted_ascii_text(initial, variant),
                    cursor,
                    keys,
                )
            )
